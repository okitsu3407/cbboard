...
Title.create(kyouka: "保健体育",yomi: "は行")
Title.create(kyouka: "コミュニケーション英語Ⅱ",yomi: "か行")
Title.create(kyouka: "EC",yomi: "あ行")
Title.create(kyouka: "ビジネス実務",yomi: "は行")
Title.create(kyouka: "課題研究",yomi: "か行")
Title.create(kyouka: "広告と販売促進",yomi: "か行")
Title.create(kyouka: "ビジネス経済応用",yomi: "は行")
Title.create(kyouka: "財務会計Ⅱ",yomi: "さ行")
